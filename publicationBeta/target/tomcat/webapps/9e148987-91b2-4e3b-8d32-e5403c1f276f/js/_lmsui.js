...
function SetConceptTop() {
    ...
    $("#lmsui_body").children().eq(1).css({display:"none"});
    // status bar
    ...
    if (showLaunchButton) {
        ...
        if (isModeAvailable("S")) {
            if (displayRequired && statobj.isRequired("S")) {
                $("#btn1 .Asterisk").css('display', 'none');
        ...
        if (isModeAvailable("T")) {
            if (displayRequired && statobj.isRequired("T")) {
                $("#btn2 .Asterisk").css('display', 'none');
        ...
        if (isModeAvailable("E")) {
            if (displayRequired && statobj.isRequired("E")) {
                $("#btn9 .Asterisk").css('display', 'none');
        ...
        if (isModeAvailable("K")) {
            if (displayRequired && statobj.isRequired("K")) {
                $("#btn3 .Asterisk").css('display', 'none');
        ...
        if (isModeAvailable("D")) {
            if (displayRequired && statobj.isRequired("D")) {
                $("#btn4 .Asterisk").css('display', 'none');
        ...
        if (isModeAvailable("P")) {
            ...
            if (ext == "pdf") {
                ...
                if (displayRequired && printItRequired) {
                    $("#btn5 .Asterisk").css('display', 'none');
                ...
                $("#btn7 .btnimage9").css('display', 'none');
                if (displayRequired && printItRequired) {
                    $("#btn6 .Asterisk").css('display', 'none');
                ...
                if (displayRequired && printItRequired) {
                    $("#btn7 .Asterisk").css('display', 'none');
...
function StartPlay(mode, frame_id, fromjumpin, path) {
    ...
    if (run) {
        if (mode == "D" || mode == "E") {
            ...
            playerWindow = window.open(urlParser.GetCorrectUrl(url), "", baseFeatures + ",scrollbars=1,resizable=1,fullscreen=0,left=" + l + ",top=" + t + ",width=" + (screen.width - 20) + ",height=" + (screen.height - 110));
        }
    }
    else {
